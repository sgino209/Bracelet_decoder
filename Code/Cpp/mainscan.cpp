...
const char* bracelet_decoder_version = "1.2";
...
void usage(char *script_name) {
  ...
  std::cout << std::endl;
  std::cout << "Optional preprocssing flags:                  --PreprocessGaussKernel --PreprocessThreshBlockSize --PreprocessThreshweight --PreprocessMorphKernel --imgEnhancementEn" << std::endl;
  ...
  std::cout << "Optional marks-detection flags (cont.):       --MinPixelArea --MaxPixelArea --MaxDrift --MarksRows --MarksCols --ROI --perspectiveMode" << std::endl;
